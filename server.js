...
// Set up Trust Proxy for deployment platforms behind load balancers (e.g. Render/Railway)
app.set("trust proxy", 1);

// CORS configuration supporting comma-separated origin list
...
// Protected Automated/External Purge Triggers
